...
function DynamicList() {
  ...
  return (
    <div className="flex flex-col lg:flex-row w-full p-6 items-center align-middle justify-center gap-4 overflow-y-auto">
      <div className="flex flex-col h-svh lg:h-[90vh] w-full lg:w-2/3 border-1 shadow-lg rounded-lg px-6 pt-6 bg-gray-50">
      ...
      {isDialogOpen && (
        <div className="flex flex-col h-svh lg:h-[90vh] w-full lg:w-1/3 border-1 rounded-lg pt-6 shadow-lg bg-gray-50">
          <ResourceDialog className="bg-white" />
          <Button
            type="submit"
            form="resourceForm"
